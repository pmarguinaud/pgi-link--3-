...
pgf90 -acc=gpu -ta=tesla -Mcuda -traceback -Mbyteswapio -Wl,--start-group ./test_load_model.o -L. -l[3] -Wl,--end-group 
pgf90 -acc=gpu -ta=tesla -Mcuda -traceback -Mbyteswapio test_load_model.o type_toto.o -o toto.x
